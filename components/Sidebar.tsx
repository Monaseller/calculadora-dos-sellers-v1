...
const MENU = [
  ...
  {
    // AJUSTE (2026-08-07 — Central de IA: iniciar/acompanhar Pipeline):
    // item novo, inserido aqui (depois de "Meus Produtos") sem mover
    // nenhum item existente — Sidebar não tem agrupamentos, então não
    // há "grupo mais coerente" formal para usar.
    href: "/central-ia",
    label: "Central de IA",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
