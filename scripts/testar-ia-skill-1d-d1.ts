...
// A pasta de conexoes ganhou o par `selecao-*` na 1D.g.1-C. O que esta
// fase precisa provar nao e "nada mudou desde a 1D.c" — isso ja e falso —
// e sim que a 1D.d nao deixou modulo proprio la. Por isso o conjunto
// nominal exato, e nao a contagem.
ok("N6  conexoes com o conjunto exato de 4 modulos — nenhum e da 1D.d",
