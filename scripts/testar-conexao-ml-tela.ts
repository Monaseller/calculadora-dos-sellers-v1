...
t("16. PRECISA_RECONECTAR oferece o OAuth existente, sem criar outro", () => {
  const c = interpretarConexaoML(200, { conectado: false, precisaReconectar: true, motivo: "PRECISA_RECONECTAR", loja: { id: "L1", nickname: "n", marketplace: "ML" } });
  const aviso = avisoConexaoML(c)!;
